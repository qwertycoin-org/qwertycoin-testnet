...
private:
    ...
    bool on_stop_wallet(const wallet_rpc::COMMAND_RPC_STOP::request &req,
    ...
    bool on_get_transaction(const wallet_rpc::COMMAND_RPC_GET_TRANSACTION::request &req,
    ...
    bool on_query_key(const wallet_rpc::COMMAND_RPC_QUERY_KEY::request &req,
                      wallet_rpc::COMMAND_RPC_QUERY_KEY::response &res);
    bool on_get_tx_key(const wallet_rpc::COMMAND_RPC_GET_TX_KEY::request &req,
    ...
    bool on_sign_message(const wallet_rpc::COMMAND_RPC_SIGN_MESSAGE::request &req,
                         wallet_rpc::COMMAND_RPC_SIGN_MESSAGE::response &res);
    bool on_verify_message(const wallet_rpc::COMMAND_RPC_VERIFY_MESSAGE::request &req,
                           wallet_rpc::COMMAND_RPC_VERIFY_MESSAGE::response &res);
    bool on_change_password(const wallet_rpc::COMMAND_RPC_CHANGE_PASSWORD::request &req,
    ...
    bool on_gen_paymentid(const wallet_rpc::COMMAND_RPC_GET_ADDRESS::request &req,
                          wallet_rpc::COMMAND_RPC_GEN_PAYMENT_ID::response &res);
    bool on_validate_address(const wallet_rpc::COMMAND_RPC_VALIDATE_ADDRESS::request &req,
                             wallet_rpc::COMMAND_RPC_VALIDATE_ADDRESS::response &res);
    bool on_rescan(const wallet_rpc::COMMAND_RPC_RESCAN::request &req,
                   wallet_rpc::COMMAND_RPC_RESCAN::response &res);
    bool on_purge(const wallet_rpc::COMMAND_RPC_PURGE::request &req,
